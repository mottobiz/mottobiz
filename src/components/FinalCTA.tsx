      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <motion.div variants={staggerItem} className="card p-6 mb-10 max-w-lg mx-auto">
            ...
            <p className="text-xs text-white/55">No credit card required. No obligation. Just pure value.</p>
          </motion.div>
          ...
          {/* Trust Badges */}
          <motion.div variants={staggerItem} className="flex flex-wrap justify-center gap-6 text-xs text-white/55">
